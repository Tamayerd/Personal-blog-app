...
export default function Navbar() {
  ...
  const navigation = [
    ...
    { name: "About Us", href: "/peoples", current: false },
    {
      name: user ? `Hello, ${user.name}!` : "Let's Cook!",
      href: user ? "/" : "/login",
      current: false,
    },
  ];
          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <img
                    ...
                    src="https://w7.pngwing.com/pngs/514/817/png-transparent-cook-logo-shape-meal-eating-icon-symbol-restaurant-thumbnail.png"
                    alt="Your Company"
                  />
                </div>
              ...
              <div className="flex items-center">
                {user !== null ?( <SearchBarFilter />): null}
